  ...
  try {
    ...
    const csvContent = [
      ...
      ...tasks.map(task => [
        ...
        (task.earlyEventTimeI ?? task.earlyStart)?.toFixed(2) || '',
        task.earlyFinish?.toFixed(2) || '',
        task.earlyEventTimeJ?.toFixed(2) || '',
        task.lateStart?.toFixed(2) || '',
        task.lateEventTimeI?.toFixed(2) || '',
        (task.lateEventTimeJ ?? task.lateFinish)?.toFixed(2) || '',
        task.eventReserveJ?.toFixed(2) || '',
