...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  searchTemplates: (q) => ipcRenderer.invoke('templates:search', q),
  getTemplate: (id) => ipcRenderer.invoke('templates:get', id),
  getRequiredPredecessors: (id, opts) => ipcRenderer.invoke('templates:requiredFor', id, opts),
  getAllRequiredTemplates: () => ipcRenderer.invoke('templates:getAllRequired'),
...
contextBridge.exposeInMainWorld('api', {
  templates: {
    ...
    requiredFor: (id, opts) => ipcRenderer.invoke('templates:requiredFor', id, opts),
  ...
  writeFile: async (filePath, data) => ipcRenderer.invoke('save-file', filePath, data),
});
